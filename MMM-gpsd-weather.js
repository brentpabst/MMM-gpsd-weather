 ...
 * MIT Licensed.
 */
Module.register("MMM-gpsd-weather", {
  ...
  getScripts: function () {
    return [
      ...
      "suncalc.js",
      this.file(
        "providers/" + this.config.weatherProvider.toLowerCase() + ".js"
      )
    ];
  },
  ...
  notificationReceived: function (notification, payload, sender) {
    ...
    } else if (notification === "GPS_DATA") {
      if (payload.class === "TPV") {
        this.weatherProvider.config.lat = payload.lat;
        this.weatherProvider.config.lon = payload.lon;
      }
  ...
  addFilters() {
    ...
    this.nunjucksEnvironment().addFilter(
      ...
      function (value, type) {
        if (type === "temperature") {
          if (
            this.config.tempUnits === "metric" ||
            this.config.tempUnits === "imperial"
          ) {
            value += "°";
          }
          ...
          if (
            ...
            if (
              this.config.weatherProvider === "ukmetoffice" ||
              this.config.weatherProvider === "ukmetofficedatahub"
            ) {
              value += "%";
            } else {
